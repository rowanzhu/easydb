...
void LogReader::Reporter::Corruption(size_t bytes, const Status& status)
{
...
LogReader::LogReader(SequentialFile* file, Reporter* reporter, bool checksum,
...
uint64_t LogReader::LastRecordOffset() {
